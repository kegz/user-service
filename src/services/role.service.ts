...
export const createRole = async (name: string, description: string | undefined, permissionCodes: string[]) => {
...
export const updateRole = async (id: string, payload: { description?: string; permissions?: string[] }) => {
